...
class TestShortDetection:
    ...
    def test_video_exactly_180_seconds_checks_ytdlp(self, scraper):
        ...
        with patch('yt_dlp.YoutubeDL') as mock_ydl:
            ...
            result = scraper._detect_short('test_id', 'Test Video', 180, {})
    ...
    def test_shorts_url_success_returns_true(self, scraper):
        ...
        with patch('yt_dlp.YoutubeDL') as mock_ydl:
            ...
            mock_instance.extract_info.assert_called_with(
                'https://www.youtube.com/shorts/test_id', 
                download=False
            )
...
class TestChannelResolution:
    ...
    def scraper(self):
        ...
        with patch.dict(os.environ, {'YOUTUBE_API_KEY': 'test_api_key'}):
            with patch('youtube_api_scraper.build') as mock_build:
    ...
    def test_resolves_handle_exactly(self, scraper):
        ...
        scraper.youtube.channels.return_value.list.assert_called_with(
            part='snippet',
            forHandle='samsulek'
        )
...
class TestEdgeCases:
    ...
    def test_similar_channel_names_resolved_exactly(self, scraper):
        ...
        # Test @samsulek
        mock_response_samsulek = {
            'items': [{
                'id': 'UC_samsulek_id',
                'snippet': {'title': 'Samsulek Channel'}
            }]
        }
